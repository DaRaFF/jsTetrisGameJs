...
require.define({
    "gamejs/event": function(require, exports, module) {
        ...
        exports.TOUCH_START = 300; //Does touch events have a standard event id?
        ...
        exports.init = function() {
            ...
            function onTouchStart (ev) {
                var canvasOffset = display._getCanvasOffset();
                QUEUE.push({
                    'type': gamejs.event.TOUCH_START,
                    'pos': [ev.touches[0].pageX - canvasOffset[0], ev.touches[0].pageY - canvasOffset[1]]
                });
            };
...
//                console.log('ctxw ' + this.context.canvas.width + ' ctxh ' + this.context.canvas.height);
//                console.log('srcCanvasWidth ' + src.canvas.width + 'srcCanvasheight ' + src.canvas.height);
//                console.log('sx ' + rArea.left + ' sy' + rArea.top + ' sWidth' + rArea.width + ' sHeight' + rArea.height + ' dx=0 dy=0 ' + ' dWidth' + rDest.width + ' dHeight' + rDest.height);
//            }
//            try{
...
}, ["gamejs/utils/matrix", "gamejs/utils/objects", "gamejs/display", "gamejs/draw", "gamejs/event", "gamejs/font", "gamejs/http", "gamejs/image", "gamejs/mask", "gamejs/mixer", "gamejs/sprite", "gamejs/surfacearray", "gamejs/time", "gamejs/transform", "gamejs/utils/arrays", "gamejs/pathfinding/astar"]);